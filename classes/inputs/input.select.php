...
class NM_Select_WPC extends WPComment_Inputs{
	...
	*/
	...
	function __construct(){
		...
		$this -> title 		= __ ( 'Select Input', 'wp-comment-fields' );
		$this -> desc		= __ ( 'regular select input', 'wp-comment-fields' );
		$this -> icon		= __ ( '<i class="fa fa-check" aria-hidden="true"></i>', 'wp-comment-fields' );
	...
	private function get_settings(){
		...
		$input_meta = array (
			...
			'options' => array (
					'type' => 'paired',
					'title' => __ ( 'Add options', 'wp-comment-fields' ),
					'desc' => __ ( 'Type option with price (optionally), Option ID should be unique and without spaces.', 'wp-comment-fields' )
			),
			'selected' => array (
					'type' => 'text',
					'title' => __ ( 'Selected option', 'wp-comment-fields' ),
					'desc' => __ ( 'Type option name given in (Add Options) tab if you want already selected.', 'wp-comment-fields' ) 
			),
			'first_option' => array (
					'type' => 'text',
