...
jQuery(function($){
    ...
    var modal = $('#wpcomment-deactivate-modal');
                            var deactivateLink = '';


                            $('#the-list').on('click', 'a.wpcomment-deactivate-link', function (e) {
                                e.preventDefault();
                            ...
                            $('#wpcomment-deactivate-modal').on('click', 'a.review-and-deactivate', function (e) {
                                e.preventDefault();
