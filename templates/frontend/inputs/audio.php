...
* 
* This template can be overridden by copying it to yourtheme/wpcomment/frontend/inputs/audio.php
* 
* @version 1.0
**/
...
$fm = new WPComment_InputManager($field_meta, 'audio');
...
if ( ! $fm->audio_video() ) {
	echo '<div class="wpcomment-option-notice">';
        echo '<p>'. __( "Please Add Some Audio/Video", "wpcomment" ) .'</p>';
    echo '</div>';
	return;
}
?>
...
<div class="<?php echo esc_attr($fm->field_inner_wrapper_classes()); ?>" >
	...
	<div class="wpcomment_audio_box">
		...
		foreach ($fm->audio_video() as $audio){ 
			...
			$audio_title_price = $audio_title . ' ' . ($audio_price > 0 ? wpcomment_price($audio_price) : '');
