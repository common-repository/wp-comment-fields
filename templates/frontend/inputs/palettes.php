...
* 
* This template can be overridden by copying it to yourtheme/wpcomment/frontend/inputs/palettes.php
* 
* @version 1.0
**/
...
$fm = new WPComment_InputManager($field_meta, 'palettes');
...
if ( ! $options ) {
	echo '<div class="wpcomment-option-notice">';
        echo '<p>'. __( "Please Add Some Option", "wpcomment" ) .'</p>';
    echo '</div>';
	return '';
}
...
$custom_css = '';
$custom_css .=  '.wpcomment-palettes label>input:checked+.wpcomment-single-palette {
...
<div class="<?php echo esc_attr($fm->field_inner_wrapper_classes()); ?>" >
	...
	<!-- Palettes Box -->
	<div class="wpcomment-palettes wpcomment-palettes-<?php echo esc_attr($fm->data_name()); ?>">
		...
		?>
			...
			<label for="<?php echo esc_attr($dom_id); ?>">
				...
				<span 
					class="wpcomment-single-palette" 
					title="<?php echo esc_attr($option_label); ?>" 
					data-wpcomment-tooltip="wpcomment_tooltip" 
